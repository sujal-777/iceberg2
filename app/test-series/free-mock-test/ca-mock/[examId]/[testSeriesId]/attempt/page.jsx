...
const handleSubmit = async () => {
  try {
    ...
    const res = await fetch("https://icebreg-backend2.onrender.com/api/test-attempt/submit", {
      method: "POST",
      headers: {
    ...
    async function fetchQuestions() {
      try {
        const res = await fetch(
          `https://icebreg-backend2.onrender.com/api/test-series/${testSeriesId}/questions`
        );
...
//     async function fetchQuestions() {
//       try {
//         const res = await fetch(`https://icebreg-backend2.onrender.com/api/test-series/${testSeriesId}/questions`);
//         const data = await res.json();
