...
export default function Discover() {
  return (
    <div className="px-4 sm:px-6 lg:px-8 xl:px-[200px]">
      <section className="relative w-full overflow-hidden rounded-xl mx-auto my-6 max-w-7xl">
        <div className="relative rounded-3xl">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-white text-center p-6 sm:p-8 md:p-10 rounded-3xl">
            ...
            {/* Paragraph is hidden on small screens, visible on medium+ screens */}
            <p
