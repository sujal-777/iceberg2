...
export default function OurMission() {
  return (
    <section className="bg-[#F5FAFF] py-16 w-full">
      {/* Inner container for content margin */}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full md:w-1/2">
            ...
            <ul className="space-y-6 text-base sm:text-lg text-gray-800 font-inter leading-relaxed">
              ...
              <li className="flex items-start gap-3">
                <span className="text-yellow-500 text-xl">⭐</span>
                <span>To allow every child to realize his/her dream, live up to their true potential, and be their lifelong learning partner.</span>
              </li>
            </ul>
          </div>
